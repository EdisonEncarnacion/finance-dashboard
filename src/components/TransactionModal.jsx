                ...
                <div className="p-6">
                    ...
                    <form className="space-y-5" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                type="date"
                                className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl px-4 py-3.5 text-slate-200 focus:outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all"
                                value={formData.date}
